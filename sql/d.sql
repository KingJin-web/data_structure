...
select *
from s
where dept in ('信息管理系','计算机系')and sname like '张%'
;
...
where student.sno=sc.sno and sc.cno=course.cno and cname='离散数学' and grade>=90;
